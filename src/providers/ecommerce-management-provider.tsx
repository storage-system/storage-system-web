...
export const EcommerceManagementContext = createContext<EcommerceManagementContext | null>(null)
...
export function EcommerceManagementProvider({
    ...
    const heroFieldArray = useFieldArray({ name: 'hero', control: heroForm.control })

    return (
        <EcommerceManagementContext.Provider
            value={{
                currentStep, colors, createStyleForm, heroForm, heroFieldArray, setCurrentStep, setColors
            }}
        >
            <Form {...form}>
...
export function useEcommerceManagement(): EcommerceManagementContext {
    ...
    if (!context) {
        throw new Error('useEcommerceManagement must be used within an EcommerceManagementProvider.')
    }
    return context
}
