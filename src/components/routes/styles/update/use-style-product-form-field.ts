...
export function useUpdateProductFormField() {
  ...
  const UPDATE_PRODUCT_FORM_FIELD_CONSTANT: FormFieldsConstant<UpdateProductType> =
    [
      [
        {
          name: 'name',
  ...
  return { UPDATE_PRODUCT_FORM_FIELD: UPDATE_PRODUCT_FORM_FIELD_CONSTANT }
}
