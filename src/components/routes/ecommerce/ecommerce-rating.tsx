...
export function Rating() {
  ...
  return (
    <Card style={{ backgroundColor: activeStyle?.backgroundColor }}>
      <CardContent className="flex flex-col gap-6">
        ...
        >
          <path
            ...
            fill={activeStyle?.primaryColor ?? '#854DFF'}
          />
        </svg>
        <p style={{ color: activeStyle?.textColor }}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: activeStyle?.textColor + 'cc' }}>Cliente</p>
            </div>
          </div>
          <div className="mt-2 flex gap-1">
            {Array.from({ length: 5 }).map((_, index) => (
              <Star
                ...
                className="size-4"
                style={{
                  fill: activeStyle?.primaryColor ?? '#facc15',
                  color: activeStyle?.primaryColor ?? '#facc15',
                }}
              />
            ))}
          </div>
